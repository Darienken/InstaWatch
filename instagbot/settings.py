"""
Django settings for instagbot project.
...
INSTALLED_APPS = [
    "instagbotapp.apps.InstagbotappConfig",
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / "instagbotapp" / "templates"],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'instagbot.wsgi.application'
